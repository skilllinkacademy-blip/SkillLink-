        ...
        <div className="relative w-full max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="space-y-5 order-2 lg:order-1">
            <div>
              {(isRtl
                ...
                : ['Work under the best.', 'Become one of them.']
              ).map((line, i) => (
                <div key={i} className="overflow-hidden">
                  <motion.h1
                    ...
                    className={`font-black leading-[1.06] tracking-tight block ${
                      i === 1
            ...
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
              ...
              <Link to="/app/opportunities"
                ...
                {isRtl ? 'עיון בהזדמנויות' : 'Browse Listings'}
              </Link>
            </motion.div>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.96, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }}
            ...
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
              ...
              <div>
                <div className="text-xs font-black text-gray-900">{isRtl ? 'נמצאה התאמה!' : 'Match Found!'}</div>
          ...
          <div className="order-2 lg:order-1">
            <Reveal className="mb-2">
              <p className="text-[11px] font-black text-blue-600 uppercase tracking-[.26em] mb-2">
                {isRtl ? 'SkillLink בפעולה' : 'How it works'}
              </p>
              ...
              <p className="text-gray-400 text-sm mt-2 leading-relaxed">
                {isRtl
                  ? 'הכישורים עוברים מיד ליד — והידע נשאר לכל החיים.'
                  : 'Skills pass from hand to hand — knowledge that lasts a lifetime.'}
              </p>
            </Reveal>
          ...
          <div className="order-1 lg:order-2">
            <Reveal className="mb-4">
              ...
              <h2 className="text-3xl sm:text-4xl font-black tracking-tight text-gray-950">
                {isRtl ? 'פשוט להתחיל.' : 'Simple to start.'}
                <span className="bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent">
                  {isRtl ? ' קריירה שלמה.' : ' Built to last.'}
                </span>
              </h2>
            </Reveal>
            ...
            {[
              {
                ...
                t: { he: 'צור פרופיל', en: 'Create a Profile' },
                d: {
                  he: 'ציין מקצוע, רמת ניסיון ומיקום. התהליך לוקח פחות משתי דקות.',
                  en: 'Enter your trade, experience level, and location. The whole process takes under two minutes.',
                },
              },
              {
                n: '02', numColor: '#6366f1',
                t: { he: 'קבל התאמות רלוונטיות', en: 'Receive Relevant Matches' },
                d: {
                  he: 'המערכת מנתחת פרופילים ומציגה את ההתאמות המדויקות ביותר עבורך.',
                  en: 'The system analyzes profiles and surfaces the most relevant matches for your specific needs.',
                },
              },
              {
              ...
              <div className="relative rounded-3xl overflow-hidden min-h-[340px] flex flex-col justify-between p-7 sm:p-9 bg-gray-950 text-white">
                ...
                <div className="relative">
                  ...
                  <ul className="space-y-2">
                    {(isRtl
                      ? [
                          'פרסם הזדמנות — ללא עלות',
                          'קבל פניות מחניכים רציניים ומסורים',
                          'מנטורים מאומתים מקבלים פי 5 יותר פניות',
                        ]
                      : [
                          'Post a listing — completely free',
                          'Receive applications from serious, committed apprentices',
                          'Verified mentors get 5× more inquiries',
                        ]
                    ).map((item, j) => (
              ...
              <div className="relative rounded-3xl overflow-hidden min-h-[340px] flex flex-col justify-between p-7 sm:p-9 border-2 border-gray-100 hover:border-blue-200 transition-colors bg-white">
                <div className="relative">
                  ...
                  <h3 className="text-2xl font-black leading-snug mb-3 text-gray-950">
                    {isRtl
                      ? <>למד ממקצוענים אמיתיים.<br />הרוויח מהיום הראשון.</>
                      : <>Learn from real professionals.<br />Earn from day one.</>}
                  </h3>
                  <ul className="space-y-2">
                    {(isRtl
                      ? [
                          'חפש מנטורים לפי מקצוע ומיקום',
                          'בדוק את ציון ההתאמה שלך לפני שאתה פונה',
                          'ניסיון מעשי אמיתי ותגמול הוגן',
                        ]
                      : [
                          'Search mentors by trade and location',
                          'Review your compatibility score before applying',
                          'Real hands-on experience with fair compensation',
                        ]
                    ).map((item, j) => (
        ...
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-start gap-6">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              {isRtl ? 'הפלטפורמה לאנשי המקצוע של מחר.' : "The platform for tomorrow's tradespeople."}
            </p>
          </div>
