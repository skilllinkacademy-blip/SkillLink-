      ...
      <div className="max-w-3xl mx-auto space-y-12">
        ...
        <div className="prose prose-emerald max-w-none space-y-8 text-gray-600 font-medium leading-relaxed">
          ...
          <section className="space-y-4">
            ...
            <p>
              {isRtl
                ? 'סימוני אימות ("מנטור מאומת") ותגי כישורים מבוססים על מידע שנמסר על ידי המשתמשים ואינם מהווים ערובה, המלצה או אישור מקצועי מטעם SkillLink לגבי כישוריו, זהותו או אמינותו של משתמש. ביקורות ודירוגים משקפים דעות אישיות של משתמשים בלבד. בהעלאת תוכן (טקסט, תמונות, תיק עבודות) אתה מעניק ל-SkillLink רישיון לא-בלעדי, עולמי וללא תמלוגים להציג ולעבד את התוכן לצורך הפעלת השירות, ומצהיר כי הוא אינו מפר זכויות של צד שלישי.'
                : 'Verification marks ("Verified Mentor") and skill badges are based on user-provided information and do not constitute a guarantee, recommendation, or professional certification by SkillLink regarding a user’s skills, identity, or reliability. Reviews and ratings reflect personal user opinions only. By uploading content (text, images, portfolio) you grant SkillLink a non-exclusive, worldwide, royalty-free license to display and process it for operating the Service, and warrant that it does not infringe third-party rights.'}
            </p>
          </section>
