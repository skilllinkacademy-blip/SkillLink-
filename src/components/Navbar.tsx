              ...
              <div className="flex items-center gap-2">
                ...
                {profile.role === 'mentor' && (
                  ...
                  >
                    <ShieldCheck size={10} />
                    {isRtl 
                      ? (profile.verification_status === 'approved' ? 'מאומת' : profile.verification_status === 'pending' ? 'בבדיקה' : 'אמת חשבון') 
                      : (profile.verification_status === 'approved' ? 'Verified' : profile.verification_status === 'pending' ? 'Pending' : 'Verify')}
                  </Link>
                )}
              </div>
            )}
